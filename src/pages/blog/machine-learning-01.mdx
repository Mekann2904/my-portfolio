...
1. **\[推奨\] BRATを利用する方法**
	...
	2. BRATの設定で \`Add Beta plugin\` を選択します。本プラグインのGitHubリポジトリURL (\` [https://github.com/Mekann2904/obsidian-textlint-highlighter-plugin](https://github.com/Mekann2904/obsidian-textlint-highlighter-plugin/releases) [\`](https://github.com/your-repo/obsidian-textlint-highlighter-plugin%60)) を入力します。
